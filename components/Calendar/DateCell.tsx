...
const DateCell = memo(function DateCell({
  ...
  const cellBase = `
    ...
    min-h-[44px] sm:min-h-[52px] w-full pt-1 sm:pt-1.5 pb-0.5 sm:pb-1 px-0.5 sm:px-1 rounded-[8px] sm:rounded-[10px]
  ...
  const numberBase = `
    text-[12px] sm:text-[13.5px] font-semibold leading-none mb-0.5
